...
| Action          | True    | Action → Tap <br/>Action → Input <br/>Action → Wait <br/>Action → Delay <br/>Action → Assert                    | a minimal semantic construct of a language that describes a change in the state of the system under test or a check of the state of the system. |
